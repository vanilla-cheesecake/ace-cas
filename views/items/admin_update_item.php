...
<body>
    ...
    <?php require 'views/templates/admin_header.php' ?>
                ...
                <div class="w-40p">
                    ...
                    <div class="card">
                        <div class="card-content">
                            <form method="POST"
                                action="api/product_controller.php?action=update&id=<?= $product->id ?>">
                                ...
                                <div class="form-control mt-16">
                                    <label>Price</label>
                                    <input value="<?= $product->price ?>" required="" type="number" step=".25"
                                        name="price" />
                                </div>
                                ...
                                <div class="form-control mt-16">
                                    ...
                                    <textarea rows="4" required="" name="description"><?= $product->description ?></textarea>
                                </div>
