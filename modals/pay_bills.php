                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="flexSwitchCheckDefault">Show Bills</label>
                            </div>
                            <!-- SELECT PAYEE TYPE -->

                            &nbsp;
                            <div class="form-group">
                                <label for="payee_type">FILTER BY</label>
                                <select class="form-control form-control-sm col-md-5" id="payee_type" name="payee_type">
                                    <option value="select payee type">Select Vendors</option>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group col-md-12">
                                <label for="payee_id">ACCOUNT<span class="text-muted"
                            ...
                            <div class="form-group col-md-12">
                                <label for="ref_no">ENDING BALANCE</label>
                        ...
                        <div class="col-md-3">
                            <!-- SELECT PAYEE -->
                            <div class="form-group col-md-12">
                                <label for="payee_id">PAYMENT METHOD<span class="text-muted"
                                        id="payee_type_display"></span></label>
                                <select class="form-control form-control-sm" id="payee_id" name="payee_id">
